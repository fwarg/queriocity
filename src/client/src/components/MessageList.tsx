...
function AiBadge() {
  return (
    <span className="inline-flex items-center gap-1 text-[11px] text-gray-500" title="Generated by an AI model">
...
function ImageBlock({ url, alt }: { url: string; alt: string }) {
  ...
  function handleDownload() {
    setError('')
    downloadGeneratedImage(url, url.split('/').pop() ?? 'image.png', caption)
