...
const INSTRUCTIONS: Record<TransformOperation, string> = {
  ...
  questions: 'Read the following resource excerpts and list the questions they leave open: gaps in the evidence, claims that are asserted without support, and what a reader would need to check next. One bullet each, no summary of the content itself.',
  outline: 'Produce a hierarchical outline of the following resource excerpts, using markdown headings and nested bullets, that mirrors how the material is actually structured. No commentary.',
}
